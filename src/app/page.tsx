        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-8">
          <div className="prose prose-slate max-w-none">
            ...
            <div className="not-prose mt-6 flex flex-wrap gap-2">
              {["Men's Wear Ellenabad","Kids Wear Ellenabad","Formal Shirts Sirsa","School Uniform Ellenabad","Wedding Blazer Ellenabad","Frock for Girls Rania","Jeans Shop Dabwali","Kurta Pajama Hanumangarh","Best Readymade Store Haryana","Chopta Fashion Shop","Jiwan Nagar Garments","Tibbi Rajasthan Readymade","Kapde Ki Dukan Ellenabad","Gurudwara Road Clothing Store","Singla Hospital Garments Store","Chautala Kapda Market","Odhan Clothing Shop","Goriwala Readymade Store","Ding Mandi Garments","Sparky Jeans Ellenabad","Mufti Shirts Ellenabad","DAV School Uniform Ellenabad","SRS School Dress Ellenabad","Kids Frock Ellenabad"].map(k=>(
