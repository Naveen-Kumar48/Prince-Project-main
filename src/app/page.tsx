      ...
      <section className="py-12 bg-[#F8F9FB] border-t">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-8">
          <div className="prose prose-slate max-w-none">
            <h2 className="text-[24px] font-bold text-[#0B1D3A]">Ajay Readymade Store – Best Cloth Shop in Ellenabad, Haryana 125102</h2>
            <p className="text-[15px] leading-relaxed text-slate-600">Welcome to Ajay Readymade Store, the <strong>best cloth shop in Ellenabad, Haryana 125102</strong> and Ellenabad&apos;s most loved family fashion destination since 1998. Located on <strong>Gurudwara Road, Near Singla Hospital, Ellenabad, Sirsa, Haryana 125102</strong>, we specialize in premium <strong>Men&apos;s Wear (45% focus)</strong> including formal shirts, casual t-shirts, polo shirts, jeans, cargo pants, trousers, jackets, blazers, and festive kurta pajamas. For <strong>Kids Wear (35% focus)</strong> we offer baby wear, boys t-shirts, girls dresses and frocks, school uniforms, party wear, winter hoodies, and ethnic festival collections. Our curated <strong>Women&apos;s Wear (20%)</strong> includes kurtis, kurti sets, palazzos, and ethnic festive wear ideal for Diwali, weddings, and family functions.</p>
            <p className="text-[15px] leading-relaxed text-slate-600">Why are we #1 on Google for “best cloth shop in Ellenabad”, “readymade cloth store in Ellenabad 125102”, “clothing store Ellenabad”, and “best kapda shop near me”? Because 5000+ families from Ellenabad, Sirsa (25km), Rania (12km), Dabwali (35km), Hanumangarh (60km), Nathusari Chopta, Jiwan Nagar, Kalanwali, Tibbi, Rawatsar, and nearby villages (Mallekan, Talwara Khurd, Pohraka, Jamal, Kuttabadh) trust us for honest pricing, premium quality, same-day alteration, and friendly staff who know your family by name. Visit us at Gurudwara Road, Near Singla Hospital, Ellenabad, Haryana 125102 for wedding shopping, festival shopping, school dress season, and year-round family fashion. Try before you buy – no online guesswork!</p>
            <div className="not-prose mt-6 flex flex-wrap gap-2">
              {["Best Cloth Shop in Ellenabad 125102","Cloth Store in Ellenabad Haryana 125102","Readymade Cloth Shop Ellenabad","Best Kapda Shop Ellenabad 125102","Gurudwara Road Cloth Shop 125102","Singla Hospital Cloth Store","Men's Wear Ellenabad 125102","Kids Wear Ellenabad 125102","Women's Wear Ellenabad 125102","Formal Shirts Sirsa","School Uniform Ellenabad 125102","Wedding Blazer Ellenabad","Frock for Girls Rania","Jeans Shop Dabwali","Kurta Pajama Hanumangarh","Best Readymade Store Haryana 125102","Chopta Fashion Shop","Jiwan Nagar Garments","Tibbi Rajasthan Readymade","Kapde Ki Dukan Ellenabad 125102","Chautala Kapda Market","Odhan Clothing Shop","Goriwala Readymade Store","Ding Mandi Garments","Sparky Jeans Ellenabad","Mufti Shirts Ellenabad","DAV School Uniform Ellenabad","Kids Frock Ellenabad"].map(k=>(
