      ...
      <section className="py-12 bg-[#F8F9FB] border-t">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-8">
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-[15px] leading-relaxed text-slate-600">Why are we #1 on Google for “Ajay Readymade Store” and “clothing store Ellenabad”? Because 5000+ families from Ellenabad, Sirsa (25km), Rania (12km), Dabwali (35km), Hanumangarh (60km), and nearby villages trust us for honest pricing, premium quality, same-day alteration, and friendly staff who know your family by name. Visit us for wedding shopping, festival shopping, school season, and year-round family fashion. Try before you buy – no online guesswork!</p>
            <div className="not-prose mt-6 flex flex-wrap gap-2">
              {["Men's Wear Ellenabad","Kids Wear Ellenabad","Formal Shirts Sirsa","School Uniform Ellenabad","Wedding Blazer Ellenabad","Frock for Girls Rania","Jeans Shop Dabwali","Kurta Pajama Hanumangarh","Best Readymade Store Haryana"].map(k=>(
                <span key={k} className="px-3 py-1 rounded-full bg-white border text-xs text-slate-600">{k}</span>
              ))}
            </div>
          </div>
        </div>
