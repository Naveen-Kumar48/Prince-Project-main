        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-[74px] lg:h-[86px] flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-2.5 flex-shrink-0">
              ...
              <button onClick={()=>setMobileOpen(v=>!v)} aria-label="Toggle navigation menu" className="lg:hidden w-10 h-10 rounded-full bg-[#F8F9FB] border border-slate-200/60 flex items-center justify-center text-[#0A1931] flex-shrink-0">
